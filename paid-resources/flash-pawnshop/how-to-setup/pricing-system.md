...
Specifies the notification system used.

```lua
Config.Notification = "ox"
```

**Options**: `"qb"`, `"esx"`, `"qbx"`, `"ox"`, `"okok"`, `"17mov"`, `"mythic"`, `"codem"` **Default**: `"ox"`
...
**Options**: `"ox"`, `"qb"`, `"TextUI"` **Default**: `"TextUI"`
